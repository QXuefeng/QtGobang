...
QT_MOC_LITERAL(1, 6, 15), // "robotClickBoard"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7) // "index_t"

    },
    "Robot\0robotClickBoard\0\0index_t"
};
...
void Robot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->robotClickBoard((*reinterpret_cast< index_t(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Robot::*)(index_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Robot::robotClickBoard)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Robot::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Robot.data,
...
// SIGNAL 0
void Robot::robotClickBoard(index_t _t1)
{
